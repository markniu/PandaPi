  ...
  void lcd_bootscreen() {
    ...
    do {
      ...
      lcd_setFont(FONT_MENU);
        ...
        u8g.drawStr(95, height - (DOG_CHAR_HEIGHT) * 1 / 2+4, STRING_SPLASH_LINE1);
        u8g.drawStr(70, height - (DOG_CHAR_HEIGHT) * 3 / 2, STRING_SPLASH_LINE2);
      #endif
    } while (u8g.nextPage());
