...
unsigned long CardReader:: get_file_size(const char *path)
{
...
void CardReader::lsDive(const char *prepend, const char * parent, const char * const match/*=NULL*/) {
	uint8_t cnt = 0;
	dir_t p;
	DIR    *dir;
	struct	 dirent    *ptr;
