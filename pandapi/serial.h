...
//
#if PANDAPI
FORCE_INLINE void serialprintPGM(const char* str);// printf(str)
...
#define SERIAL_PROTOCOLCHAR(x)             Serial_send_char(x)// SERIAL_CHAR(x)
#define SERIAL_PROTOCOL(x)                   MYSERIAL0.print(x)
#define SERIAL_PROTOCOL_F(x,y)              MYSERIAL0.print(x,y)
#define SERIAL_PROTOCOLPGM(x)              serialprintPGM(x)// serialprintPGM(PSTR(x))
