...
//PANDAPI  #error "Unsupported MCU architecture"
...
#define DELAY_NS(x)       delay_ns0(x)// PANDAPI  DELAY_CYCLES(_NS_TO_CYCLES(x))
#define DELAY_NS_VAR(x)  delay_ns0(x)// PANDAPI  DELAY_CYCLES_VAR(_NS_TO_CYCLES(x))
#define DELAY_US(x) delay_ns0(x*1000)
