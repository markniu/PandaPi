 ...
 * @return the output width (in pixels on GLCD)
 */
//luojin inline int lcd_put_u8str(FSTR_P const fstr) { return lcd_put_u8str_P(FTOP(fstr)); }
 ...
 * @param row
 */
//luojin inline int lcd_put_u8str(const lcd_uint_t col, const lcd_uint_t row, const char * const str) {
//  lcd_moveto(col, row);
