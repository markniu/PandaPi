...
public:
  ...
  static void clear_lcd();
   ...
   static void set_status(FSTR_P const fstr, const int level=0);
...
#define LCD_MESSAGE_F(S)       ui.set_status(F(S),(int8_t)1)
#define LCD_MESSAGE(M)         ui.set_status(GET_TEXT_F(M),(int8_t)1)
