...
void Adafruit_NeoPixel::begin(void) {
  ...
  begun = true;
  pi_version=read_version_led();//GetIniKeyInt("VER","PI","/home/pi/Config_panda.ini");
 
 printf("led_show begin== \n");
}
