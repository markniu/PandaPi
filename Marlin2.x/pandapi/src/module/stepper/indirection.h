...
#ifndef X_STEP_WRITE
#define X_STEP_WRITE(STATE) {WRITE(X_STEP_PIN,STATE);delay_step();}//  PANDAPI
#endif
...
#ifndef Y_STEP_WRITE
#define Y_STEP_WRITE(STATE) {WRITE(Y_STEP_PIN,STATE);delay_step();}//  PANDAPI
#endif
...
#ifndef Z_STEP_WRITE
#define Z_STEP_WRITE(STATE){ WRITE(Z_STEP_PIN,STATE);delay_step();}//  PANDAPI
#endif
...
#define E0_STEP_WRITE(STATE) {WRITE(E0_STEP_PIN,STATE);delay_step();}//  PANDAPI
#endif
...
#define E1_STEP_WRITE(STATE) {WRITE(E1_STEP_PIN,STATE);delay_step();}//  PANDAPI
#endif
...
#include "../../feature/bedlevel/bdl/bdl.h"
  #define DISABLE_AXIS_Z() if (SHOULD_DISABLE(z)) { DISABLE_STEPPER_Z(); DISABLE_STEPPER_Z2(); DISABLE_STEPPER_Z3(); DISABLE_STEPPER_Z4(); AFTER_CHANGE(z, false); set_axis_untrusted(Z_AXIS); Z_RESET(); BD_Level.BDsensor_config=0;}
#else
  #define DISABLE_AXIS_Z() if (SHOULD_DISABLE(z)) { DISABLE_STEPPER_Z(); DISABLE_STEPPER_Z2(); DISABLE_STEPPER_Z3(); DISABLE_STEPPER_Z4(); AFTER_CHANGE(z, false); set_axis_untrusted(Z_AXIS); Z_RESET();}
#endif
