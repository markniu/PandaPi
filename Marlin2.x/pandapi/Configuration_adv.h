...
#if ENABLED(SENSORLESS_HOMING)//PANDAPI
...
//
  ...
  #if EITHER(DGUS_LCD_UI_FYSETC, DGUS_LCD_UI_HIPRECY)||ENABLED(DGUS_LCD_UI_PANDAPI)||ENABLED(DGUS_LCD_UI_MKS)
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      E0_CURRENT_PI
    #define E0_MICROSTEPS    16
  ...
  #if AXIS_IS_TMC(E1)
    #define E1_CURRENT      E1_CURRENT_PI
  ...
  #if AXIS_IS_TMC(E2)
    #define E2_CURRENT      E2_CURRENT_PI
    #define E2_MICROSTEPS   E0_MICROSTEPS
